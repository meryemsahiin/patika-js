...
function displayMenu(menuItems) {
  foodMenu.innerHTML = menuItems.map(element => `
...
// Menü filtreleme işlevi
function filterMenu(event) {
  const categoryId = event.target.id;
  const filteredMenu = categoryId === "All" ? menu : menu.filter(element => element.category === categoryId);
